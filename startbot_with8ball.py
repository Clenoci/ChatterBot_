...
ballsack = ["Yes.", "No.", "Maybe.", "Perhaps.", "Not likely.", "Very likely.", "Remember, licking doorknobs is illegal on other planets.", "I don't know. I just sell CRT TVs."]
...
#special thanks to Full Stack Python for providing the functions these were modeled after:
...
#        response = Chatbot.bot.get_response(None) #this crashes the program when called
    ...
    elif "!8ball" in command:
        response = ballsack[randint(0,7)]
