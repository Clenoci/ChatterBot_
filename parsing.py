...
time_of_day=('am|pm|Am|Pm|a.m|p.m')
...
#adjusted the regular expression
# works without minutes as far as i have been able to test.4
# works best with
...
regex = [
    ...
    (
        re.compile(
            ...
            ''' % (re_time),
            #instead of (%s) # Matches time 12:00
            (re.VERBOSE | re.IGNORECASE),
        ),
        lambda m, base_date: datetime(
            base_date.year,
